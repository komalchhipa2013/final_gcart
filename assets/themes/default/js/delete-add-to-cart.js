				...
				success:function(data)
				{
					...
					else
					{
						...
						$(".sub-total").text("");
                            ...
                            var div="<div class='shopping-cart-table'><div class='text-center' style='height: 150px; padding-top: 70px'><div ><b>"+cart_empty_title+"</b></div><div><p >"+cart_empty_msg+"</p></div><div ><a href='"+url+"' class='btn btn-primary'>"+shop_now+"</a></div></div></div>"
