...
<?php
						            		...
						            		$old_price = get_product($wishlist['product_id'], 'old_price');
						            		 ...
						            		 $hotdeals_price=hot_deals_price($wishlist['product_id'],get_product($wishlist['product_id'], 'quantity'),$price);
...
<?php
									...
									{
?>
										<a href="" class="btn-upper btn btn-primary" disabled="disabled"><?php _el('item_not_available');?></a>
<?php
									}
?>
									</td>
...
<?php
						...
						{
?>
							<div class="text-center" style="height: 150px; padding-top: 40px">
		...
		$.ajax({
				...
				success:function(data)
				{
					...
					if(data.wishlist_detail == null)
					{
						...
						var div="<div class='text-center' style='height: 150px; padding-top: 40px'><div ><b>"+wishlist_empty_title+"</b></div><div><p >"+wishlist_empty_msg+"</p></div><div ><a href='"+url+"' class='btn btn-primary'>"+shop_now+"</a></div></div>"
