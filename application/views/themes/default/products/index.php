...
?>
          <div class="search-result-container ">
            <div id="myTabContent" class="tab-content category-list" style="">
              <div class="tab-pane active " id="grid-container" height="300px">
...
<?php 
                  ...
                  { 
                    $wishlist_li_class = (!empty( wishlist_styel_class($product['id'])))? wishlist_styel_class($product['id']) :'lnk wishlist';   
?>      
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="<?= site_url('Products/'.$product['slug']); ?>"><img  src="<?php echo base_url(); ?><?php echo $product['thumb_image']; ?>" alt="" width="249px" height="249px"></a> </div>
                          <!-- /.image -->
...
<?php
                          ...
                          $hotdeals_price = hot_deals_price($product['id'],$product['quantity'],$product['price']);

                           if(!empty($hotdeals_price))
                           {
                              $price     = $hotdeals_price['price'];
                              $old_price = $hotdeals_price['old_price'];
                           }
?>
                    ...
                    <div class="product-list product">
                      <div class="row product-list-row">
                        <div class="col col-sm-4 col-lg-4">
                          <div class="product-image">
                            <div class="image"> <img src="<?php echo base_url(); ?>/<?php echo $product['thumb_image']; ?>" alt="" width="249px" height="249px"> </div>
                          </div>
                          <!-- /.product-image --> 
                        </div>
                        <!-- /.col -->
...
?>
                            ...
                            {
?>
                                    <button class="btn btn-primary icon" data-toggle="dropdown" disabled type="button" > <i class="fa fa-shopping-cart"></i> </button>
                                    <button class="btn btn-primary cart-btn" type="button" disabled ><?php _el('item_not_available');?></button>
<?php
                            }
?>
                                  </li>
