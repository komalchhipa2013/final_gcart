...
<?php
			            		...
			            		$old_price = $products_detail['old_price'];
			            		 ...
			            		 $hotdeals_price=hot_deals_price($products_detail['id'],$products_detail['quantity'],$products_detail['price']);
...
?>
										<div class="col-sm-7">
											<a href="" class="btn btn-primary" disabled="disabled"><i class="fa fa-shopping-cart inner-right-vs"></i><?php _el('item_not_available'); ?></a>
										</div>
<?php
									}
?>
...
<?php
					...
					{	
						...
						{
							$wishlist_li_class = (!empty( wishlist_styel_class($upsell['id'])))? wishlist_styel_class($upsell['id']) :'lnk wishlist';		
?>
...
<?php
				            		...
				            		$hotdeals_price = hot_deals_price( $upsell['id'], $upsell['quantity'], $upsell['price']);
...
// ================================= comments submit ===============================================
    ...
    $("#frm_comments").on('submit',function(e){
    	...
    	if(comments != "" && email != "" && name != "" && comments_len > 10)
    	{
    		$.ajax({
				type:'POST',
				...
				success:function(msg)
				{
					...
					$(".comment-success-msg").html(div).show().fadeOut(3000);
				}
    		...
    		$.ajax({
				...
				success:function(msg)
				{
					...
					else if(msg == 'success')
					{
						...
						$("#exampleInputTag").val("");
						$(".tags-success-msg").html(div).show().fadeOut(3000);
