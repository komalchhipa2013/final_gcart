...
<div class="body-content outer-top-xs">
    <div class="container">
        <div class="row ">
            ...
            <!-- =============================================== hidden input ===========================================================================-->
<?php
                          $price          = get_product($cart_item['product_id'], 'price');
                          $hotdeals_price = hot_deals_price($cart_item['product_id'],$cart_item['product_id'],$price);

                           if(!empty($hotdeals_price))
                           {
                              $price     = $hotdeals_price['price']; 
                           }
?>               
                                                    ...
                                                    <input type="hidden" name="products_price" id="products_price_<?php echo $cart_item['id'] ?>" value="<?php echo  $price; ?>">
             <!-- =============================================== hidden input ===========================================================================-->
                                                </div>
                                                 <?php
                                                    ...
                                                    {
                                                ?>
                                                 <span id="no-qty-msg-<?php echo $cart_item['id'] ?>" style="display: block;color: red; font-size: 10px;font-weight: bold;"><?php _el('not_available')?></span>
                                                 <?php
                                                     }
                                                 ?>
                                            </td>
                                            ...
                                            <td class="cart-product-sub-total">
                                                <span class="cart-sub-total-price" id="price_<?php echo $cart_item['id'] ?>">
                                                    <?php _el('rupees');?>&nbsp;<?php echo $price; ?>
                                                </span>
                                            </td>
                                            <td class="cart-product-grand-total" >
                                                <span class="cart-grand-total-price" id="total_amount_<?php echo $cart_item['id'] ?>" value="<?php echo $cart_item['total_amount']; ?>">
                                                    <?php _el('rupees');?>&nbsp;<?php echo $cart_item['total_amount']; ?>
                                                </span>
                                            </td>
...
?>
                                ...
                                <tr>
                                    <th style="background-color: white;" id="discount_td">
                                        <div class="cart-grand-total">
                                            <?php _el('grand_total');?>
                                            <span class="inner-left-md"><?php _el('rupees');?>.&nbsp;
    ...
    <?php
        ...
        {
            ?>
                <div class="text-center" style="height: 150px; padding-top: 70px">
...
<script type="text/javascript">
    ...
    function checkcout()
    {
        window.location = SITE_URL+'Shipping_Address';
    }
    ...
    function update_cart(qty,cart_id,products_name,products_price)
    {
        ...
        {
            var price      = $('#products_price_' + cart_id).val();
            ...
            $.ajax({
                    ...
                    success: function (data)
                    {
                        if (data.msg == 'true')
                        {
                            ...
                            $('#no-qty-msg-'+cart_id).css('display', 'none');
